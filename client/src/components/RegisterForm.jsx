        ...
        <div className='flex flex-col space-y-5'>
            ...
            <form className='flex flex-col text-sm space-y-4' onSubmit={handleSubmit}>
                ...
                <div className='flex flex-row justify-end'>
                    <input type='submit' value='CRÉER LE COMPTE' className='bg-blue-600 text-white font-semibold py-1 px-3 rounded text-lg hover:shadow-lg hover:scale-105 cursor-pointer ease-out transition-all duration-300' />
                </div>
            </form>
