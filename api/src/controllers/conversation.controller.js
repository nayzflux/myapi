...
module.exports.createConversation = async (req, res) => {
    ...
    const convAlreadyExists = await Conversation.findOne({ users: { $all: [...users, self._id], $size: [...users, self._id].length } }).populate('users').exec();
    console.log(convAlreadyExists);
